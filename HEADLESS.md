...
| `--direction` | `both` | filter arah entry: `long`/`short` only, `auto` = hanya searah bias trend 4H (EMA20/50 klines 4h, refresh 5 menit), `auto_strict` = searah 4H **dan** bias 1m (entry hanya saat pullback selesai/resumption) |
